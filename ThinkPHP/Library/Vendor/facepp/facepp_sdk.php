...
class Facepp
{
    ...
    public $api_key         = '0e58c8e85f15b5eecc2569069709eabb';        // set your API KEY or set the key static in the property
    public $api_secret      = '18Te968-nC4PlUsHSjpEekONYtEbk9RZ';        // set your API SECRET or set the secret static in the property
